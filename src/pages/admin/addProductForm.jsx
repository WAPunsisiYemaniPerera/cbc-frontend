        ...
        <div className="w-full h-full rounded-lg flex justify-center items-center">
            <div className="w-[500px] h-[600px] bg-blue-100 rounded-lg shadow-2xl flex flex-col items-center">
                ...
                <div className="w-[400px] h-[100px] flex justify-between items-center rounded-lg">
                    ...
                    <button onClick={handleSubmit} className="bg-green-500 cursor-pointer text-white p-[10px] w-[180px] text-center rounded-lg hover:bg-green-600 ml-[10px]">Add Product</button>
                </div>
            </div>
        </div>
    )
